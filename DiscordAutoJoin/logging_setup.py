...
class Console:
    ...
    @staticmethod
    def info(msg, silent=False, category="SYS"):
        Console._log("INFO", category, msg, silent)

    @staticmethod
    def ok(msg, silent=False, category="SYS"):
        Console._log("OK", category, msg, silent)

    @staticmethod
    def warn(msg, silent=False, category="SYS"):
        Console._log("WARN", category, msg, silent)

    @staticmethod
    def error(msg, silent=False, category="SYS"):
